<?php 
/*
Plugin Name: WP better Workflow
Plugin URI: http://wordpress.org/plugins/wp-better-workflow
Description: WP Better Workflow is a plugin that checks if user has permissions to publish pages/posts/custom post types. If they don't, it will send it to review by someone who can publish.
Author: jamesawesome
Version: 1.0
